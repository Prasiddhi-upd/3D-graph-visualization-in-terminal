...
export class DotParser {
    ...
    parse(dot_string) {
        ...
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(dot_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.dotparser_parse(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('dot_parser_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
